...
public class EditChild extends AppCompatActivity implements EditTuitionFragment.OnFragmentInteractionListener,ViewTuitionFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new EditTuitionTabLayoutAdapter(getSupportFragmentManager(), receivedChildID, this);
